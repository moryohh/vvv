...
عند رفع ملف قديم بلا `layout` يحاول الموقع فصل الإجابة المركبة إلى مربعات مستقلة إذا كانت الأجزاء مفصولة بـ« و » أو « ، » وتنقسم الخيارات الأربعة بالطريقة نفسها. أما تحديد مواضع جميع الثوابت والكسور والرموز داخل معادلة كاملة فيحتاج `layout` صريحًا؛ ملف قديم فيه إجابة واحدة لا يخبر الموقع أي الأرقام معطى ثابت وأيها ينبغي إخفاؤه.
